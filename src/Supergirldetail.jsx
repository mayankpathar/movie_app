                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="./images/series/supergirl.jpg" alt="Supergirl poster" />
                        ...
                        <div className="title-block">
                            ...
                            <p className="synopsis">
                                A young woman discovers she has extraordinary powers and decides to use them to help people.
                            </p>
...
export default Supergirldetail
