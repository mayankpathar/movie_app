                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="/images/series/star-trek.jpg" alt="Star Trek poster" />
                        ...
                        <div className="title-block">
                            <h1>Star Trek</h1>
                            <div className="meta">2009 • 2h 14m • <span className="rating">★ 7.0/10</span></div>
