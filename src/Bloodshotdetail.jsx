                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="./images/movies/blood-shot.jpg" alt="Blood Shot poster" />
                        ...
                        <div className="title-block">
                            <h1>Blood Shot</h1>
                            <div className="meta">2020 • 2h 14m • <span className="rating">★ 7.0/10</span></div>
                            <p className="synopsis">
                                A former soldier turned assassin must go on the run after being framed for a crime he didn't commit.
                            </p>
...
export default Bloodshotdetail
