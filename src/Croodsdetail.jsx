                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="/images/cartoons/croods.jpg" alt="Croods poster" />
                        ...
                        <div className="title-block">
                            <h1>Croods</h1>
                            <div className="meta">2020 • 2h 14m • <span className="rating">★ 7.5/10</span></div>
                            <p className="synopsis">
                                A family of cave dwellers must venture out into the world to survive.
                            </p>
