                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="./images/cartoons/dragon.jpg" alt="Dragon Ball poster" />
                        ...
                        <div className="title-block">
                            ...
                            <p className="synopsis">
                                A young boy discovers he has incredible powers and must protect his family and the world from various threats.
                            </p>
