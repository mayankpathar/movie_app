                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="./images/cartoons/coco.jpg" alt="Coco poster" />
                        ...
                        <div className="title-block">
                            <h1>Coco</h1>
                            <div className="meta">2017 • 1h 49m • <span className="rating">★ 8.4/10</span></div>
                            <p className="synopsis">
                                A young boy dreams of becoming a musician, but his family forbids it.
                            </p>
