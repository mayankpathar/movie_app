...
function TheFalconAndTheWinterSoldierdetail() {
  return (
    <div>
                ...
                <main className="movie-main">
                    <div className="left-col">
                        <div className="poster-wrap">
                            <img src="/images/series/the-falcon.webp" alt="The Falcon and The Winter Soldier poster" />
...
export default TheFalconAndTheWinterSoldierdetail
